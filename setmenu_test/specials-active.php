...
if(isset($_POST['submit']))
{
	...
	while($Special = mysql_fetch_array($rt_Specials))
	{
		...
		$sql_ChangeActive .=" WHERE id=".$Special['id'];
...
?>
  <div class="Main">
    <div class="MainVideoPane" >
      ...
      <form id="Activate" name="Activate" method="post" action="Active_Specials.php">
        <p class="Menu_Item_Header">Activate/Inactivate Specials</p>
      ...
      <p class="HighlightBodyType">Sunday</p>
		...
		?>
		<br />
      	<input type="submit" name="submit" id="submit" value="Change Active" />
      </form>
